...
export const LoginComponent = () => {
  ...
  return (
    <div className="lg:flex lg:min-h-screen">
      {/* Left Side - Merchant Wall (Desktop only) */}
      <MerchantWall />

      {/* Right Side - Login Form */}
      <div className="w-full lg:w-1/2 bg-linear-to-br from-[#589442]/5 via-gray-50 to-[#FCB53B]/10 lg:bg-gray-50 min-h-screen flex items-center justify-center p-4 pt-8 lg:pt-4">
        <div className="w-full max-w-md">
          {/* Logo Section - Hidden on lg */}
          <div className="lg:hidden text-center mb-6">
            <h1 className="text-3xl font-bold text-gray-700 mb-4">
              Plataforma para Lojistas e Profissionais
            </h1>

            {/* Badges Row */}
            <div className="flex flex-wrap gap-2 justify-center mb-6">
              <div className="inline-flex items-center gap-2 bg-[#589442] border border-[#589442] rounded-full px-3 py-1.5">
